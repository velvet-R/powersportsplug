...
import { BLOG_CONTENTS, POSTS } from '@/lib/constants'
...
export default function BlogPostDetailsPage({ params }: Props): React.JSX.Element {
  const resolvedParams = use(params)

  // Find metadata block
  const post = POSTS.find((p) => p.slug === resolvedParams.slug)
  // Pull structured text blocks
  const articleBlocks = BLOG_CONTENTS[resolvedParams.slug]
